...
from va_kmeans_cl import ProcesadorArchivo
from va_format import EncabezadoLammps

class CriticalClusterAnalyzer:
 

    def __init__(self,cuttof_cluster):
        self.cuttof_clust = cuttof_cluster
    ...
    def run(self):
        ...
        for cluster in numero_cluster_critic:
            ...
            indice_particion = 0
            if dispersion_cluster_1 < self.cuttof_clust:
                indice_particion = 0
            elif dispersion_cluster_2 < self.cuttof_clust:
                indice_particion = 1
            elif dispersion_cluster_3 < self.cuttof_clust:
                indice_particion = 2
